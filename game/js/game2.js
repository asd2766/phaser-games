...
game.myState.preload = {
  preload: function() {
    // game.load.image('preload', '/game/images/game/preload.gif');
...
game.myState.load = {
  preload: function() {
    game.load.image('clock', '/game/images/game/clock.png');
    game.load.image('gamebg', '/game/images/game/game-bg.jpg'); // 游戏背景
    game.load.image('iconfinder', '/game/images/game/iconfinder.png');
    game.load.spritesheet('dog', '/game/images/game/dog.png', 266, 360, 2); // 加载需要找到的狗
    game.load.image('man1', '/game/images/game/man1.png');
    game.load.image('man2', '/game/images/game/man2.png');
    game.load.image('man3', '/game/images/game/man3.png');
    game.load.image('man4', '/game/images/game/man4.png');
    game.load.image('man5', '/game/images/game/man5.png');
    game.load.image('man6', '/game/images/game/man6.png');
    game.load.image('man7', '/game/images/game/man7.png');
    game.load.image('man8', '/game/images/game/man8.png');
    game.load.image('man9', '/game/images/game/man9.png');
    game.load.image('man10', '/game/images/game/man10.png');
    game.load.image('man11', '/game/images/game/man11.png');
    game.load.image('man12', '/game/images/game/man12.png');
    game.load.image('man13', '/game/images/game/man13.png');
    game.load.image('man14', '/game/images/game/man14.png');
    game.load.image('man15', '/game/images/game/man15.png');
    game.load.image('man16', '/game/images/game/man16.png');
    game.load.audio('find', '/game/images/game/find.mp3');
    game.load.audio('bgmusic', '/game/images/game/bgmusic.mp3');
  },
  create: function() {
